...
function add()
	...
	'QUERY COMMAND
	strSQL_add = "INSERT INTO users(FirstName,AccountType,LastName,Username,`Password`,Email)values('"&Request("firstn")&"','"&Request("atype")&"','"&Request("lastn")&"','"&Request("usn")&"',SHA1('"&Request("user")&""&Request("pwds")&"'),'"&Request("email")&"')"
