...
<%
	...
	'QUERY COMMAND
	strSQL_rem = "DELETE from code_language_reference WHERE ID='"&Request("IDREC")&"'"
...
Dim cmd, strSQL_act
	...
	strSQL_act = "INSERT into actlogs (ACTuser, ACTdate, ACTdescription) values ('"&Request.Cookies("USERNAME")&"', NOW(), 'Has remove a language')"
