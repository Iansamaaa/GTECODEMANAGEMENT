  ...
  <body class="fixed-nav" id="page-top">
    ...
    <div class="content-wrapper py-3"><!--Start of the Content-->
      <div class="container-fluid" id="CONTAINER3">
        ...
        <div class="card-header gray"><h3><i class="fa fa-users" aria-hidden="true"></i>Active Members</h3><br><button id="AddMemberFunc" type="submit" class="btn btn-primary btn-md" data-toggle="modal" data-target="#AddMemberModal" title="Add codes"><i class="fa fa-plus" aria-hidden="true"></i>Add Members</button>
          </div>
          <div class="card-body">
