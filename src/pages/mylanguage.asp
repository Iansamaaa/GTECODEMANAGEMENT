...
<html lang="en">
  <head>
    ...
    <!-- JS -->
    <script src="../Js/langjs/mylanguage.js"></script>
  </head>
    ...
    <div class="content-wrapper py-3 smallsizecontainer"><!--Start of the Content-->
      <div class="container-fluid">
       ...
       <center><div class="card mb-4 smalltable" style="display:none" id="tablecard">
          <div class="card-header blue" align="left"><button type="submit" class="btn btn-primary btn-md" id="refreshtab"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;Refresh</button>
          </div>
